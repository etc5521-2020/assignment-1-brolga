...
Figure \@ref(fig:critic-positive-wordcloud) shows the most used positive words in the critic reviews while figure \@ref(fig:critic-negative-word cloud) shows the most negative words. By direct observation of the number of terms in the two word clouds, the positivity seems to overpower the negativity in the critics reviews.
