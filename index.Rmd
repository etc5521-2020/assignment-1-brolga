...
Although it has been 5 months since the game was released worldwide, it has been gaining alot of attention from both players and critics. Even non-players may find the concept of this game well designed and interesting.
...
# Motivation
For the motivation,why choose the <animals crossing> for ours topic.animals crossing hasbeen one of the biggest selling games in months at the switch platform. We want to know that what the reason is. Though analysis the user's feedback, critic and the game mode(such as the villagers and the iteams)to get the reason.
